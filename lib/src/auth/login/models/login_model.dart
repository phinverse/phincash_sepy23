...
class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
    ...
    mainWalletAmount: json["main_wallet_amount"] == null ? null : int.parse(json["main_wallet_amount"]),
    secondaryWalletAmount: json["secondary_wallet_amount"] == null ? null : int.parse(json["secondary_wallet_amount"]),
    ...
    currentLoanId: json["current_loan_id"] == null ? null : json["current_loan_id"],
    //currentLoanId:  json['current_loan_id']==null?'':json['current_loan_id'],

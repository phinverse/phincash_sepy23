const kPrivacyAgreement = [
  {
    'heading' : 'User privacy agreement',
    "data" : 'Thank you for trusting and using PhinCash service! We promise not to '
        'share your information to 3rd parties.After you register, we will collect some related '
        'information such as location and other information for us to serve you better. We '
        'promise to continuously improve security and other measures to ensure the '
        'security if your personal information.',
  },
  {
...
const kPrivacy = [
  ...
  },
  {
    ...
    "data" : 'We only use your personal information for necessary and related purposes. These are as follows: '
        ...
        '\n\nWe use it to log and respond to support queries when users are having issues with the dashboard, mobile '

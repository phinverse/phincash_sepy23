...
class LoanDeclinedDialog{
  BuildContext? context;
  LoanDeclinedDialog({this.context});
  showLoanDeclinedDialog(BuildContext context){
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text("Transaction Declined!", textAlign: TextAlign.center,
                                style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: kPrimaryColor, fontWeight: FontWeight.w700, fontSize: 20),),
                              const SizedBox(height: 20,),
                              Text("Your Loan request was declined. Please try again later", textAlign: TextAlign.center,
